...
const swagger_config_1 = require("./config/swagger.config"); // Importar la configuración de Swagger
const routes_1 = require("./routes"); // Importar los routers principales
// Cron Job Logic
